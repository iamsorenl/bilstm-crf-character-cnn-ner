...
def get_result(
    ...
    print(
        "processed %i tokens with %i phrases; "
        % (sum_true_counts, sum_true_chunks),
        end="",
    )
    print(
    ...
    print(
        "accuracy: %6.2f%%; " % (100 * sum_correct_counts / sum_true_counts),
        end="",
    )
    ...
    for t in chunk_types:
        ...
        print("%17s: " % t, end="")
        print(
            "precision: %6.2f%%; recall: %6.2f%%; FB1: %6.2f"
            % (prec, rec, f1),
            end="",
        )
